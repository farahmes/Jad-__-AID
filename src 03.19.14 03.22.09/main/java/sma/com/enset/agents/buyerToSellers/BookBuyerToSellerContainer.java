...
public class BookBuyerToSellerContainer extends Application{
	protected BookBuyerToSellerAgent bookBuyerAgent;
	...
	private void startContainer() throws Exception {
		...
		AgentController consumerAgent = 
			container.createNewAgent("BookBuyerAgent", BookBuyerToSellerAgent.class.getName(), 
					new Object[]{this});
		consumerAgent.start();
